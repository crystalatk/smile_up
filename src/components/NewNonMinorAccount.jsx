        ...
        <>
            ...
            <form onSubmit={_handleSubmit}>
                ...
                <label>Create a Password
                    <input type="password" value={password} onChange={_handlePasswordChange} required></input>
                </label>
                <label>Retype your password
                <input type="password" value={password2} onChange={_handlePassword2Change} required></input>
                </label>
                {!!passwordsMatch ? null : (
                    <h6 className="f-red f-small">Your passwords do not match</h6>
                )}
                <label>First Name
                    <input type="text" value={firstName} onChange={_handleFirstNameChange} required ></input>
                </label>
                <label>Last Name
                    <input  type="text" value={lastName} onChange={_handleLastNameChange} required></input>
                </label>
                <label>Date of Birth
                ...
                <label>Emergency Contact Name (First & Last)
                    <input type="text" value={emergencyName} onChange={_handleEmergencyNameChange} required></input>
                </label>
                ...
                <label>Are you the parent or guardian of a smileUp volunteer who is under the age of 18?
                    <input type="radio" value={true} onChange={_handleIsGuardianChange} name="is_guardian"/> Yes
                    <input type="radio" value={false} onChange={_handleIsGuardianChange} name="is_guardian"/> No
                </label>
                <label>Would you like to include a message to the administrator? If so, enter below:
                    <input type="text" value={signUpMessage} onChange={_handleSignUpMessageChange} required></input>
                </label>
